...
Feature: Email
  ...
  Scenario Outline: Normal Flow
    ...
    And I "Send" the email with subject and body
    ...
    Examples:
      ...
      | djadeeb@gmail.com             | /Users/adeeb27/Downloads/attachments/preview17.png       | Second Tes  | Second Test |
  ...
  Scenario: Alternate Flow
    ...
    Given I am logged in
    And I am on the Gmail main page
    When I compose an email to "adrianguindani@gmail.com"
    And I attach a file "/Users/adeeb27/Downloads/attachments/preview6.png"
    And I "Send" the email with no subject and body
    Then the email should be sent with "/Users/adeeb27/Downloads/attachments/preview6.png"

  Scenario: Error Flow
    #Invalid email addresses, an example is address without "@" sign
    Given I am logged in
    And I am on the Gmail main page
